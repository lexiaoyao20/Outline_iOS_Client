...
//      print("Failed to retrive app container directory")
//      return
//    }
...
//    defaultDebugLevel = DDLogLevel.info
  ...
  func addVpnExtensionLogsToSentry() {
    ...
    do {
      ...
      print("Failed to list logs directory. Not sending VPN logs")
      return
    }
    ...
    for logFile in logs.sorted().reversed() {
      ...
      print("Reading log file: \(String(describing: logFilePath))")
      do {
  ...
  private func parseTimestamp(in log:String) -> (String, String)? {
    do {
      ...
      print("Failed to parse timestamp: \(error)")
    }
    return nil
  }
}
