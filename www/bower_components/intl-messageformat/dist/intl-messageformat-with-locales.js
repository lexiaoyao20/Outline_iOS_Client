...
(function () {
  ...
  $$es5$$defineProperty($$core$$MessageFormat, '__addLocaleData', { value: function value(data) {
      if (!(data && data.locale)) {
  ...
  var $$en$$default = { "locale": "en", "pluralRuleFunction": function pluralRuleFunction(n, ord) {
