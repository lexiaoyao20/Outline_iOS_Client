...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        extract_cldr_data: {
            ...
            src_en: {
                ...
                options: {
                    ...
                    wrapEntry: function wrapEntry(entry) {
            ...
            lib_all: {
                ...
                options: {
                    prelude: ['// GENERATED FILE', 'var IntlMessageFormat = require("./core")["default"];\n\n'].join('\n'),
        ...
        uglify: {
            ...
            dist_with_locales: {
                ...
                files: {
                    'dist/intl-messageformat-with-locales.min.js': ['dist/intl-messageformat-with-locales.js']
                }
            }
        },
        ...
        'saucelabs-mocha': {
            all: {
                options: {
                    urls: ['http://127.0.0.1:9999/tests/index.html', 'http://127.0.0.1:9999/tests/browserify/index.html'],
    ...
    grunt.registerTask('sauce', ['browserify', 'connect', 'saucelabs-mocha']);

    grunt.registerTask('cldr', ['extract_cldr_data']);

    grunt.registerTask('default', ['jshint', 'clean', 'cldr', 'bundle_jsnext', 'concat:dist_with_locales', 'uglify', 'json_remove_fields', 'cjs_jsnext', 'copy:tmp']);
};