...
(function (shared, scope, testing) {
  ...
  scope.Animation.prototype = {
    ...
    _setExternalAnimation: function _setExternalAnimation(animation) {
    ...
    _arrangeChildren: function _arrangeChildren(childAnimation, offset) {
    ...
    _forEachChild: function _forEachChild(f) {
      var offset = 0;
