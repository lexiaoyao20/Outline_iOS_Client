...
(function (shared, scope, testing) {
  ...
  constructor.prototype = {
    _isAncestor: function _isAncestor(effect) {
      var a = this;
      while (a !== null) {
    ...
    _reparent: function _reparent(newChildren) {
      scope.removeMulti(newChildren);
      for (var i = 0; i < newChildren.length; i++) {
        newChildren[i]._parent = this;
      }
    },
    _putChild: function _putChild(args, isAppend) {
